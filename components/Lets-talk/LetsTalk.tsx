...
const LetsTalk = () => {
  return (
    <section className={`w-full text-white max-w-[90%] md:max-w-[80%] md:h-[292px] text-center md:text-left md:px-20 flex py-12 flex-col md:flex-row md:justify-between items-center self-center rounded-2xl gap-4 md:gap-0  ${styles.letsTalk}`}>
