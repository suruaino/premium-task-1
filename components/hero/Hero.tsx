...
const Hero = () => {
    return(
        <section className={`hero w-full md:w-[80%] h-[843px] md:h-[640px] md:px-20 pt-20 md:pt-0 flex flex-col md:flex-row md:items-center justify-center gap-12 md:rounded-2xl overflow-hidden  relative ${styles.hero}`}>
            <div className="left w-full text-center md:text-left max-w-[90%] flex flex-col gap-10 items-center md:items-start self-center">
